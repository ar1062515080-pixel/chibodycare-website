...
export const staff: StaffMember[] = [
  {
    ...
    specialties: ["acupuncture", "additional-services", "aromatherapy"],
    focus: ["Acupuncture", "Chinese Medicine", "Fire Cupping"],
    yearsExperience: 15,
    initials: "ML",
  ...
  },
  {
    ...
    specialties: ["remedial-pregnancy", "deep-recovery", "additional-services"],
    focus: ["Remedial", "Deep Recovery", "Fire Cupping"],
    yearsExperience: 10,
    initials: "DC",
  ...
  },
  {
    ...
    focus: ["Relaxation", "Aromatherapy", "Deluxe"],
    yearsExperience: 8,
    initials: "SN",
  ...
  },
  {
    ...
    specialties: ["foot-care", "relaxation", "deluxe-customised"],
    focus: ["Foot Care", "Relaxation", "Deluxe"],
    yearsExperience: 9,
    initials: "AO",
  ...
  },
  {
    ...
    focus: ["Deep Recovery", "Remedial", "Deluxe"],
    yearsExperience: 12,
    initials: "JP",
